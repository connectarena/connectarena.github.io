function RecordRTC(b,a){function c(c){c&&(a.initCallback=function(){c();c=a.initCallback=null});l=new (new GetRecorderType(b,a))(b,a);l.record();x("recording");a.disableLogs||console.log("Initialized recorderType:",l.constructor.name,"for output-type:",a.type)}function e(b){function c(c){if(l){Object.keys(l).forEach(function(a){"function"!==typeof l[a]&&(g[a]=l[a])});var e=l.blob;if(!e)if(c)l.blob=e=c;else throw"Recording failed.";e&&!a.disableLogs&&console.log(e.type,"->",bytesToSize(e.size));b&&
(c=URL.createObjectURL(e),"function"===typeof b.call?b.call(g,c):b(c));a.autoWriteToDisk&&t(function(b){var c={};c[a.type+"Blob"]=b;DiskStorage.Store(c)})}else"function"===typeof b.call?b.call(g,""):b("")}b=b||function(){};l?"paused"===g.state?(g.resumeRecording(),setTimeout(function(){e(b)},1)):("recording"===g.state||a.disableLogs||console.warn('Recording state should be: "recording", however current state is: ',g.state),a.disableLogs||console.log("Stopped recording "+a.type+" stream."),"gif"!==
a.type?l.stop(c):(l.stop(),c()),x("stopped")):m()}function f(a){postMessage((new FileReaderSync).readAsDataURL(a))}function t(b,c){function e(a){a=URL.createObjectURL(new Blob([a.toString(),"this.onmessage =  function (e) {"+a.name+"(e.data);}"],{type:"application/javascript"}));var b=new Worker(a);URL.revokeObjectURL(a);return b}if(!b)throw"Pass a callback function over getDataURL.";var w=c?c.blob:(l||{}).blob;if(w)if("undefined"===typeof Worker||navigator.mozGetUserMedia){var g=new FileReader;g.readAsDataURL(w);
g.onload=function(a){b(a.target.result)}}else g=e(f),g.onmessage=function(a){b(a.data)},g.postMessage(w);else a.disableLogs||console.warn("Blob encoder did not finish its job yet."),setTimeout(function(){t(b,c)},1E3)}function p(a){a=a||0;"paused"===g.state?setTimeout(function(){p(a)},1E3):"stopped"!==g.state&&(a>=g.recordingDuration?e(g.onRecordingStopped):(a+=1E3,setTimeout(function(){p(a)},1E3)))}function x(a){if(g)if(g.state=a,"function"===typeof g.onStateChanged.call)g.onStateChanged.call(g,a);
else g.onStateChanged(a)}function m(){!0!==a.disableLogs&&console.warn(r)}if(!b)throw"First parameter is required.";a=a||{type:"video"};a=new RecordRTCConfiguration(b,a);var g=this,r='It seems that recorder is destroyed or "startRecording" is not invoked for '+a.type+" recorder.",l,q={startRecording:function(e){e&&(a=new RecordRTCConfiguration(b,e));a.disableLogs||console.log("started recording "+a.type+" stream.");if(l)return l.clearRecordedData(),l.record(),x("recording"),g.recordingDuration&&p(),
g;c(function(){g.recordingDuration&&p()});return g},stopRecording:e,pauseRecording:function(){l?"recording"!==g.state?a.disableLogs||console.warn("Unable to pause the recording. Recording state: ",g.state):(x("paused"),l.pause(),a.disableLogs||console.log("Paused recording.")):m()},resumeRecording:function(){l?"paused"!==g.state?a.disableLogs||console.warn("Unable to resume the recording. Recording state: ",g.state):(x("recording"),l.resume(),a.disableLogs||console.log("Resumed recording.")):m()},
initRecorder:c,setRecordingDuration:function(a,b){if("undefined"===typeof a)throw"recordingDuration is required.";if("number"!==typeof a)throw"recordingDuration must be a number.";g.recordingDuration=a;g.onRecordingStopped=b||function(){};return{onRecordingStopped:function(a){g.onRecordingStopped=a}}},clearRecordedData:function(){l?(l.clearRecordedData(),a.disableLogs||console.log("Cleared old recorded data.")):m()},getBlob:function(){if(l)return l.blob;m()},getDataURL:t,toURL:function(){if(l)return URL.createObjectURL(l.blob);
m()},getInternalRecorder:function(){return l},save:function(a){l?invokeSaveAsDialog(l.blob,a):m()},getFromDisk:function(b){l?RecordRTC.getFromDisk(a.type,b):m()},setAdvertisementArray:function(b){a.advertisement=[];for(var c=b.length,e=0;e<c;e++)a.advertisement.push({duration:e,image:b[e]})},blob:null,bufferSize:0,sampleRate:0,buffer:null,reset:function(){l&&"function"===typeof l.clearRecordedData&&l.clearRecordedData();l=null;x("inactive");g.blob=null},onStateChanged:function(b){a.disableLogs||console.log("Recorder state changed:",
b)},state:"inactive",getState:function(){return g.state},destroy:function(){var b=a.disableLogs;a.disableLogs=!0;g.reset();a={};x("destroyed");q=g=null;Storage.AudioContextConstructor&&(Storage.AudioContextConstructor.close(),Storage.AudioContextConstructor=null);b||console.warn("RecordRTC is destroyed.")},version:"5.4.6"};if(!this)return g=q;for(var v in q)this[v]=q[v];g=this;return q}RecordRTC.version="5.4.6";"undefined"!==typeof module&&(module.exports=RecordRTC);
...
null;"function"===typeof a.video&&(e=a.video);var f=b;if(isMediaRecorderCompatible()&&a.audio&&"function"===typeof a.audio){var t=b.getVideoTracks()[0];navigator.mozGetUserMedia?(f=new MediaStream,f.addTrack(t),e&&e===WhammyRecorder&&(e=MediaStreamRecorder)):f=new MediaStream([t])}this.videoRecorder=new RecordRTC(f,{type:"video",video:this.video,canvas:this.canvas,frameInterval:this.frameInterval||10,disableLogs:this.disableLogs,recorderType:e,mimeType:c.video,timeSlice:this.timeSlice,onTimeStamp:this.onTimeStamp});
...
function MediaStreamRecorder(b,a){function c(){p.timestamps.push((new Date).getTime());if("function"===typeof a.onTimeStamp)a.onTimeStamp(p.timestamps[p.timestamps.length-1],p.timestamps)}function e(b){return g&&g.mimeType?g.mimeType:b.mimeType||"video/webm"}function f(){m=[];g=null;p.timestamps=[]}function t(){if("active"in b){if(!b.active)return!1}else if("ended"in b&&b.ended)return!1;return!0}var p=this;if("undefined"===typeof b)throw'First argument "MediaStream" is required.';if("undefined"===
...
a.mimeType&&"audio/ogg"!==a.mimeType.toString().toLowerCase()&&navigator.mozGetUserMedia&&(a.mimeType="audio/ogg")}var m=[];this.getArrayOfBlobs=function(){return m};this.record=function(){p.blob=null;p.clearRecordedData();p.timestamps=[];r=[];m=[];var f=a;a.disableLogs||console.log("Passing following config over MediaRecorder API.",f);g&&(g=null);isChrome&&!isMediaRecorderCompatible()&&(f="video/vp8");"function"===typeof MediaRecorder.isTypeSupported&&f.mimeType&&!MediaRecorder.isTypeSupported(f.mimeType)&&
(a.disableLogs||console.warn("MediaRecorder API seems unable to record mimeType:",f.mimeType),f.mimeType="audio"===a.type?"audio/webm":"video/webm");try{g=new MediaRecorder(b,f),a.mimeType=f.mimeType}catch(q){g=new MediaRecorder(b)}f.mimeType&&!MediaRecorder.isTypeSupported&&"canRecordMimeType"in g&&!1===g.canRecordMimeType(f.mimeType)&&(a.disableLogs||console.warn("MediaRecorder API seems unable to record mimeType:",f.mimeType));g.ignoreMutedMedia=!0===a.ignoreMutedMedia;g.ondataavailable=function(b){b.data&&
r.push("ondataavailable: "+bytesToSize(b.data.size));"number"===typeof a.timeSlice?b.data&&b.data.size&&100<b.data.size&&(m.push(b.data),c(),"function"===typeof a.ondataavailable&&(b=a.getNativeBlob?b.data:new Blob([b.data],{type:e(f)}),a.ondataavailable(b))):!b.data||!b.data.size||100>b.data.size||p.blob?p.recordingCallback&&(p.recordingCallback(new Blob([],{type:e(f)})),p.recordingCallback=null):(p.blob=a.getNativeBlob?b.data:new Blob([b.data],{type:e(f)}),p.recordingCallback&&(p.recordingCallback(p.blob),
p.recordingCallback=null))};g.onstart=function(){r.push("started")};g.onpause=function(){r.push("paused")};g.onresume=function(){r.push("resumed")};g.onstop=function(){r.push("stopped")};g.onerror=function(b){r.push("error: "+b);a.disableLogs||(-1!==b.name.toString().toLowerCase().indexOf("invalidstate")?console.error("The MediaRecorder is not in a state in which the proposed operation is allowed to be executed.",b):-1!==b.name.toString().toLowerCase().indexOf("notsupported")?console.error("MIME type (",
...
g.stop()};"number"===typeof a.timeSlice?(c(),g.start(a.timeSlice)):g.start(36E5);a.initCallback&&a.initCallback()};this.timestamps=[];this.stop=function(b){p.manuallyStopped=!0;g&&(this.recordingCallback=b||function(){},"recording"===g.state&&g.stop(),"number"===typeof a.timeSlice&&setTimeout(function(){p.blob=new Blob(m,{type:e(a)});p.recordingCallback(p.blob)},100))};this.pause=function(){g&&"recording"===g.state&&g.pause()};this.resume=function(){g&&"paused"===g.state&&g.resume()};this.clearRecordedData=
function(){g&&"recording"===g.state&&p.stop(f);f()};var g;this.getInternalRecorder=function(){return g};this.blob=null;this.getState=function(){return g?g.state||"inactive":"inactive"};var r=[];this.getAllStates=function(){return r};"undefined"===typeof a.checkForInactiveTracks&&(a.checkForInactiveTracks=!1);p=this;(function q(){g&&!1!==a.checkForInactiveTracks&&(!1===t()?(a.disableLogs||console.log("MediaStream seems stopped."),p.stop()):setTimeout(q,1E3))})();this.name="MediaStreamRecorder";this.toString=
...
b.noWorker)c(b,function(b){a(b.buffer,b.view)});else{var e=f(c);e.onmessage=function(b){a(b.data.buffer,b.data.view);URL.revokeObjectURL(e.workerURL)};e.postMessage(b)}}function f(b){b=URL.createObjectURL(new Blob([b.toString(),";this.onmessage =  function (e) {"+b.name+"(e.data);}"],{type:"application/javascript"}));var a=new Worker(b);a.workerURL=b;return a}function t(){g=[];r=[];q=0;H=l=u=!1;A=null;m.leftchannel=g;m.rightchannel=r;m.numberOfAudioChannels=v;m.desiredSampRate=B;m.sampleRate=F;m.recordingLength=
q;z=[];C=[];J=0}function p(){E&&(E.onaudioprocess=null,E.disconnect(),E=null);n&&(n.disconnect(),n=null);t()}function x(){l&&"function"===typeof a.ondataavailable&&"undefined"!==typeof a.timeSlice&&(z.length?(e({desiredSampRate:B,sampleRate:F,numberOfAudioChannels:v,internalInterleavedLength:J,leftBuffers:z,rightBuffers:1===v?[]:C},function(b,c){var e=new Blob([c],{type:"audio/wav"});a.ondataavailable(e);setTimeout(x,a.timeSlice)}),z=[],C=[],J=0):setTimeout(x,a.timeSlice))}if(!b.getAudioTracks().length)throw"Your stream has no audio tracks.";
a=a||{};var m=this,g=[],r=[],l=!1,q=0,v=2,B=a.desiredSampRate;!0===a.leftChannel&&(v=1);1===a.numberOfAudioChannels&&(v=1);if(!v||1>v)v=2;a.disableLogs||console.log("StereoAudioRecorder is set to record number of channels: ",v);"undefined"===typeof a.checkForInactiveTracks&&(a.checkForInactiveTracks=!0);this.record=function(){if(!1===c())throw"Please make sure MediaStream is active.";t();u=H=!1;l=!0;"undefined"!==typeof a.timeSlice&&x()};this.stop=function(b){b=b||function(){};l=!1;e({desiredSampRate:B,
sampleRate:F,numberOfAudioChannels:v,internalInterleavedLength:q,leftBuffers:g,rightBuffers:1===v?[]:r},function(a,c){m.blob=new Blob([c],{type:"audio/wav"});m.buffer=new ArrayBuffer(c.buffer.byteLength);m.view=c;m.sampleRate=B||F;m.bufferSize=y;m.length=q;u=!1;b&&b(m.blob)})};Storage.AudioContextConstructor||(Storage.AudioContextConstructor=new Storage.AudioContext);var A=Storage.AudioContextConstructor,n=A.createMediaStreamSource(b),w=[0,256,512,1024,2048,4096,8192,16384],y="undefined"===typeof a.bufferSize?
...
a.disableLogs||(console.log("sample-rate",F),console.log("buffer-size",y),a.desiredSampRate&&console.log("Desired sample-rate",a.desiredSampRate));var H=!1;this.pause=function(){H=!0};this.resume=function(){if(!1===c())throw"Please make sure MediaStream is active.";l?H=!1:(a.disableLogs||console.log("Seems recording has been restarted."),this.record())};this.clearRecordedData=function(){a.checkForInactiveTracks=!1;l&&this.stop(p);p()};this.name="StereoAudioRecorder";this.toString=function(){return this.name};
var u=!1;E.onaudioprocess=function(b){if(!H)if(!1===c()&&(a.disableLogs||console.log("MediaStream seems stopped."),E.disconnect(),l=!1),l){if(!u){u=!0;if(a.onAudioProcessStarted)a.onAudioProcessStarted();a.initCallback&&a.initCallback()}var e=b.inputBuffer.getChannelData(0);e=new Float32Array(e);g.push(e);if(2===v){b=b.inputBuffer.getChannelData(1);var w=new Float32Array(b);r.push(w)}q+=y;m.recordingLength=q;"undefined"!==typeof a.timeSlice&&(J+=y,z.push(e),2===v&&C.push(w))}else n&&(n.disconnect(),
n=null)};E.connect(A.destination);this.leftchannel=g;this.rightchannel=r;this.numberOfAudioChannels=v;this.desiredSampRate=B;this.sampleRate=F;m.recordingLength=q;var z=[],C=[],J=0}"undefined"!==typeof RecordRTC&&(RecordRTC.StereoAudioRecorder=StereoAudioRecorder);
function CanvasRecorder(b,a){function c(){B.frames=[];q=l=!1}function e(){var a=document.createElement("canvas"),c=a.getContext("2d");a.width=b.width;a.height=b.height;c.drawImage(b,0,0);return a}function f(){if(q)return v=(new Date).getTime(),setTimeout(f,500);if("canvas"===b.nodeName.toLowerCase()){var c=(new Date).getTime()-v;v=(new Date).getTime();B.frames.push({image:e(),duration:c});l&&setTimeout(f,a.frameInterval)}else html2canvas(b,{grabMouse:"undefined"===typeof a.showMousePointer||a.showMousePointer,
onrendered:function(b){var c=(new Date).getTime()-v;if(!c)return setTimeout(f,a.frameInterval);v=(new Date).getTime();B.frames.push({image:b.toDataURL("image/webp",1),duration:c});l&&setTimeout(f,a.frameInterval)}})}if("undefined"===typeof html2canvas)throw"Please link: https://cdn.webrtc-experiment.com/screenshot.js";a=a||{};a.frameInterval||(a.frameInterval=10);var t=!1;["captureStream","mozCaptureStream","webkitCaptureStream"].forEach(function(b){b in document.createElement("canvas")&&(t=!0)});
var p=(!!window.webkitRTCPeerConnection||!!window.webkitGetUserMedia)&&!!window.chrome,x=50,m=navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./);p&&m&&m[2]&&(x=parseInt(m[2],10));p&&52>x&&(t=!1);var g;if(t)if(a.disableLogs||console.log("Your browser supports both MediRecorder API and canvas.captureStream!"),b instanceof HTMLCanvasElement)var r=b;else if(b instanceof CanvasRenderingContext2D)r=b.canvas;else throw"Please pass either HTMLCanvasElement or CanvasRenderingContext2D.";else navigator.mozGetUserMedia&&
(a.disableLogs||console.error("Canvas recording is NOT supported in Firefox."));var l;this.record=function(){l=!0;if(t&&!a.useWhammyRecorder){var b;"captureStream"in r?b=r.captureStream(25):"mozCaptureStream"in r?b=r.mozCaptureStream(25):"webkitCaptureStream"in r&&(b=r.webkitCaptureStream(25));try{var c=new MediaStream;c.addTrack(b.getVideoTracks()[0]);b=c}catch(w){}if(!b)throw"captureStream API are NOT available.";g=new MediaStreamRecorder(b,{mimeType:"video/webm"});g.record()}else B.frames=[],v=
(new Date).getTime(),f();a.initCallback&&a.initCallback()};this.getWebPImages=function(c){if("canvas"===b.nodeName.toLowerCase()){var e=B.frames.length;B.frames.forEach(function(b,c){var w=e-c;a.disableLogs||console.log(w+"/"+e+" frames remaining");if(a.onEncodingCallback)a.onEncodingCallback(w,e);w=b.image.toDataURL("image/webp",1);B.frames[c].image=w});a.disableLogs||console.log("Generating WebM")}c()};this.stop=function(b){l=!1;var c=this;t&&g?g.stop(b):this.getWebPImages(function(){B.compile(function(e){a.disableLogs||
console.log("Recording finished!");c.blob=e;c.blob.forEach&&(c.blob=new Blob([],{type:"video/webm"}));b&&b(c.blob);B.frames=[]})})};var q=!1;this.pause=function(){q=!0;g instanceof MediaStreamRecorder&&g.pause()};this.resume=function(){q=!1;g instanceof MediaStreamRecorder?g.resume():l||this.record()};this.clearRecordedData=function(){l&&this.stop(c);c()};this.name="CanvasRecorder";this.toString=function(){return this.name};var v=(new Date).getTime(),B=new Whammy.Video(100)}
"undefined"!==typeof RecordRTC&&(RecordRTC.CanvasRecorder=CanvasRecorder);
function WhammyRecorder(b,a){function c(b){b="undefined"!==typeof b?b:10;var a=(new Date).getTime()-l;if(!a)return setTimeout(c,b,b);if(x)return l=(new Date).getTime(),setTimeout(c,100);l=(new Date).getTime();r.paused&&r.play();g.drawImage(r,0,0,m.width,m.height);q.frames.push({duration:a,image:m.toDataURL("image/webp")});p||setTimeout(c,b,b)}function e(b){var a=-1,c=b.length;(function w(){a++;a===c?b.callback():setTimeout(function(){b.functionToLoop(w,a)},1)})()}function f(b,a,c,f,w){var g=document.createElement("canvas");
g.width=m.width;g.height=m.height;var n=g.getContext("2d"),v=[],p=-1===a,u=a&&0<a&&a<=b.length?a:b.length,z=Math.sqrt(Math.pow(255,2)+Math.pow(255,2)+Math.pow(255,2)),t=c&&0<=c&&1>=c?c:0,B=f&&0<=f&&1>=f?f:0,G=!1;e({length:u,functionToLoop:function(a,c){var e,k,h,d=function(){!G&&h-e<=h*B||(p&&(G=!0),v.push(b[c]));a()};if(G)d();else{var I=new Image;I.onload=function(){n.drawImage(I,0,0,m.width,m.height);var b=n.getImageData(0,0,m.width,m.height);e=0;k=b.data.length;h=b.data.length/4;for(var a=0;a<
k;a+=4)Math.sqrt(Math.pow(b.data[a]-0,2)+Math.pow(b.data[a+1]-0,2)+Math.pow(b.data[a+2]-0,2))<=z*t&&e++;d()};I.src=b[c].image}},callback:function(){v=v.concat(b.slice(u));0>=v.length&&v.push(b[b.length-1]);w(v)}})}function t(){q.frames=[];p=!0;x=!1}a=a||{};a.frameInterval||(a.frameInterval=10);a.disableLogs||console.log("Using frames-interval:",a.frameInterval);this.record=function(){a.width||(a.width=320);a.height||(a.height=240);a.video||(a.video={width:a.width,height:a.height});a.canvas||(a.canvas=
{width:a.width,height:a.height});m.width=a.canvas.width||320;m.height=a.canvas.height||240;g=m.getContext("2d");a.video&&a.video instanceof HTMLVideoElement?(r=a.video.cloneNode(),a.initCallback&&a.initCallback()):(r=document.createElement("video"),setSrcObject(b,r),r.onloadedmetadata=function(){a.initCallback&&a.initCallback()},r.width=a.video.width,r.height=a.video.height);r.muted=!0;r.play();l=(new Date).getTime();q=new Whammy.Video;a.disableLogs||(console.log("canvas resolutions",m.width,"*",
m.height),console.log("video width/height",r.width||m.width,"*",r.height||m.height));c(a.frameInterval)};var p=!1;this.stop=function(b){b=b||function(){};p=!0;var c=this;setTimeout(function(){f(q.frames,-1,null,null,function(e){q.frames=e;a.advertisement&&a.advertisement.length&&(q.frames=a.advertisement.concat(q.frames));q.compile(function(a){c.blob=a;c.blob.forEach&&(c.blob=new Blob([],{type:"video/webm"}));b&&b(c.blob)})})},10)};var x=!1;this.pause=function(){x=!0};this.resume=function(){x=!1;
p&&this.record()};this.clearRecordedData=function(){p||this.stop(t);t()};this.name="WhammyRecorder";this.toString=function(){return this.name};var m=document.createElement("canvas"),g=m.getContext("2d"),r,l,q}"undefined"!==typeof RecordRTC&&(RecordRTC.WhammyRecorder=WhammyRecorder);
...
id:163}}))}function c(b){for(var a=[];0<b;)a.push(b&255),b>>=8;return new Uint8Array(a.reverse())}function e(b){return new Uint8Array(b.split("").map(function(b){return b.charCodeAt(0)}))}function x(b){var a=[];b=(b.length%8?Array(9-b.length%8).join("0"):"")+b;for(var c=0;c<b.length;c+=8)a.push(parseInt(b.substr(c,8),2));return new Uint8Array(a)}function m(b){for(var a=[],g=0;g<b.length;g++){var f=b[g].data;"object"===typeof f&&(f=m(f));"number"===typeof f&&(f=x(f.toString(2)));"string"===typeof f&&
...
b.frame}function r(b,a){return parseInt(b.substr(a+4,4).split("").map(function(b){b=b.charCodeAt(0).toString(2);return Array(8-b.length+1).join("0")+b}).join(""),2)}function l(b){for(var a=0,c={};a<b.length;){var e=b.substr(a,4),f=r(b,a),g=b.substr(a+4+4,f);a+=8+f;c[e]=c[e]||[];"RIFF"===e||"LIST"===e?c[e].push(l(g)):c[e].push(g)}return c}function q(b){return[].slice.call(new Uint8Array((new Float64Array([b])).buffer),0).map(function(b){return String.fromCharCode(b)}).reverse().join("")}b=new function(b){if(b[0]){for(var c=
...
{data:q(c.duration),id:17545}]},{id:374648427,data:[{id:174,data:[{data:1,id:215},{data:1,id:29637},{data:0,id:156},{data:"und",id:2274716},{data:"V_VP8",id:134},{data:"VP8",id:2459272},{data:1,id:131},{id:224,data:[{data:c.width,id:176},{data:c.height,id:186}]}]}]}]}];for(f=e=0;e<b.length;){var y=[];g=0;do y.push(b[e]),g+=b[e].duration,e++;while(e<b.length&&3E4>g);y={id:524531317,data:a(f,0,y)};c[1].data.push(y);f+=g}return m(c)}(b.map(function(b){for(var a=l(atob(b.image.slice(23))),c=a.RIFF[0].WEBP[0],
...
function GifRecorder(b,a){if("undefined"===typeof GIFEncoder){var c=document.createElement("script");c.src="https://cdn.webrtc-experiment.com/gif-recorder.js";(document.body||document.documentElement).appendChild(c)}a=a||{};var e=b instanceof CanvasRenderingContext2D||b instanceof HTMLCanvasElement;this.record=function(){function b(c){if(!0!==q.clearedRecordedData){if(f)return setTimeout(function(){b(c)},100);g=requestAnimationFrame(b);if(!(90>c-r)){!e&&m.paused&&m.play();e||p.drawImage(m,0,0,t.width,
t.height);if(a.onGifPreview)a.onGifPreview(t.toDataURL("image/png"));l.addFrame(p);r=c}}}if("undefined"===typeof GIFEncoder)setTimeout(q.record,1E3);else if(x){e||(a.width||(a.width=m.offsetWidth||320),a.height||(a.height=m.offsetHeight||240),a.video||(a.video={width:a.width,height:a.height}),a.canvas||(a.canvas={width:a.width,height:a.height}),t.width=a.canvas.width||320,t.height=a.canvas.height||240,m.width=a.video.width||320,m.height=a.video.height||240);l=new GIFEncoder;l.setRepeat(0);l.setDelay(a.frameRate||
200);l.setQuality(a.quality||10);l.start();if("function"===typeof a.onGifRecordingStarted)a.onGifRecordingStarted();Date.now();g=requestAnimationFrame(b);a.initCallback&&a.initCallback()}else setTimeout(q.record,1E3)};this.stop=function(b){b=b||function(){};g&&cancelAnimationFrame(g);Date.now();this.blob=new Blob([new Uint8Array(l.stream().bin)],{type:"image/gif"});b(this.blob);l.stream().bin=[]};var f=!1;this.pause=function(){f=!0};this.resume=function(){f=!1};this.clearRecordedData=function(){q.clearedRecordedData=
!0;l&&(l.stream().bin=[])};this.name="GifRecorder";this.toString=function(){return this.name};var t=document.createElement("canvas"),p=t.getContext("2d");e&&(b instanceof CanvasRenderingContext2D?(p=b,t=p.canvas):b instanceof HTMLCanvasElement&&(p=b.getContext("2d"),t=b));var x=!0;if(!e){var m=document.createElement("video");m.muted=!0;m.autoplay=!0;x=!1;m.onloadedmetadata=function(){x=!0};setSrcObject(b,m);m.play()}var g=null,r,l,q=this}"undefined"!==typeof RecordRTC&&(RecordRTC.GifRecorder=GifRecorder);
function MultiStreamsMixer(b){function a(b,c,e){if("createObjectURL"in B&&!e)try{c.src=B.createObjectURL(b)}catch(F){a(b,c,!0)}else"srcObject"in c?c.srcObject=b:"mozSrcObject"in c?c.mozSrcObject=b:alert("createObjectURL/srcObject both are not supported.")}function c(){if(!g){var b=m.length,a=!1,f=[];m.forEach(function(b){b.stream||(b.stream={});b.stream.fullcanvas?a=b:f.push(b)});if(a)r.width=a.stream.width,r.height=a.stream.height;else if(f.length){r.width=1<b?2*f[0].width:f[0].width;var p=1;if(3===
b||4===b)p=2;if(5===b||6===b)p=3;if(7===b||8===b)p=4;if(9===b||10===b)p=5;r.height=f[0].height*p}else r.width=q.width||360,r.height=q.height||240;a&&a instanceof HTMLVideoElement&&e(a);f.forEach(function(b,a){e(b,a)});setTimeout(c,q.frameInterval)}}function e(b,a){if(!g){var c=0,e=0,f=b.width,u=b.height;1===a&&(c=b.width);2===a&&(e=b.height);3===a&&(c=b.width,e=b.height);4===a&&(e=2*b.height);5===a&&(c=b.width,e=2*b.height);6===a&&(e=3*b.height);7===a&&(c=b.width,e=3*b.height);"undefined"!==typeof b.stream.left&&
(c=b.stream.left);"undefined"!==typeof b.stream.top&&(e=b.stream.top);"undefined"!==typeof b.stream.width&&(f=b.stream.width);"undefined"!==typeof b.stream.height&&(u=b.stream.height);l.drawImage(b,c,e,f,u);if("function"===typeof b.stream.onRender)b.stream.onRender(l,c,e,f,u,a)}}function f(){x();var b;"captureStream"in r?b=r.captureStream():"mozCaptureStream"in r?b=r.mozCaptureStream():q.disableLogs||console.error("Upgrade to latest Chrome or otherwise enable this flag: chrome://flags/#enable-experimental-web-platform-features");
var a=new A;b.getVideoTracks().forEach(function(b){a.addTrack(b)});return r.stream=a}function t(){n.AudioContextConstructor||(n.AudioContextConstructor=new n.AudioContext);q.audioContext=n.AudioContextConstructor;q.audioSources=[];!0===q.useGainNode&&(q.gainNode=q.audioContext.createGain(),q.gainNode.connect(q.audioContext.destination),q.gainNode.gain.value=0);var a=0;b.forEach(function(b){b.getAudioTracks().length&&(a++,b=q.audioContext.createMediaStreamSource(b),!0===q.useGainNode&&b.connect(q.gainNode),
q.audioSources.push(b))});if(a)return q.audioDestination=q.audioContext.createMediaStreamDestination(),q.audioSources.forEach(function(b){b.connect(q.audioDestination)}),q.audioDestination.stream}function p(b){var c=document.createElement("video");a(b,c);c.muted=!0;c.volume=0;c.width=b.width||q.width||360;c.height=b.height||q.height||240;c.play();return c}function x(a){m=[];a=a||b;a.forEach(function(b){if(b.getVideoTracks().length){var a=p(b);a.stream=b;m.push(a)}})}var m=[],g=!1,r=document.createElement("canvas"),
l=r.getContext("2d");r.style="opacity:0;position:absolute;z-index:-1;top: -100000000;left:-1000000000; margin-top:-1000000000;margin-left:-1000000000;";(document.body||document.documentElement).appendChild(r);this.disableLogs=!1;this.frameInterval=10;this.width=360;this.height=240;this.useGainNode=!0;var q=this,v=window.AudioContext;"undefined"===typeof v&&("undefined"!==typeof webkitAudioContext&&(v=webkitAudioContext),"undefined"!==typeof mozAudioContext&&(v=mozAudioContext));var B=window.URL;"undefined"===
...
v:"undefined"!==typeof webkitAudioContext&&(n.AudioContext=webkitAudioContext);this.startDrawingFrames=function(){c()};this.appendStreams=function(a){if(!a)throw"First parameter is required.";a instanceof Array||(a=[a]);b.concat(a);a.forEach(function(b){if(b.getVideoTracks().length){var a=p(b);a.stream=b;m.push(a)}b.getAudioTracks().length&&q.audioContext&&(b=q.audioContext.createMediaStreamSource(b),b.connect(q.audioDestination),q.audioSources.push(b))})};this.releaseStreams=function(){m=[];g=!0;
q.gainNode&&(q.gainNode.disconnect(),q.gainNode=null);q.audioSources.length&&(q.audioSources.forEach(function(b){b.disconnect()}),q.audioSources=[]);q.audioDestination&&(q.audioDestination.disconnect(),q.audioDestination=null);q.audioContext=null;l.clearRect(0,0,r.width,r.height);r.stream&&(r.stream.stop(),r.stream=null)};this.resetVideoStreams=function(b){!b||b instanceof Array||(b=[b]);x(b)};this.name="MultiStreamsMixer";this.toString=function(){return this.name};this.getMixedStream=function(){g=
!1;var a=f(),c=t();c&&c.getAudioTracks().forEach(function(b){a.addTrack(b)});b.forEach(function(b){});return a}}
function MultiStreamRecorder(b,a){function c(){var a=[];b.forEach(function(b){b.getVideoTracks().forEach(function(b){a.push(b)})});return a}b=b||[];var e=this,f,t;a=a||{mimeType:"video/webm",video:{width:360,height:240}};a.frameInterval||(a.frameInterval=10);a.video||(a.video={});a.video.width||(a.video.width=360);a.video.height||(a.video.height=240);this.record=function(){f=new MultiStreamsMixer(b);c().length&&(f.frameInterval=a.frameInterval||10,f.width=a.video.width||360,f.height=a.video.height||
240,f.startDrawingFrames());a.previewStream&&"function"===typeof a.previewStream&&a.previewStream(f.getMixedStream());t=new MediaStreamRecorder(f.getMixedStream(),a);t.record()};this.stop=function(b){t&&t.stop(function(a){e.blob=a;b(a);e.clearRecordedData()})};this.pause=function(){t&&t.pause()};this.resume=function(){t&&t.resume()};this.clearRecordedData=function(){t&&(t.clearRecordedData(),t=null);f&&(f.releaseStreams(),f=null)};this.addStreams=function(a){if(!a)throw"First parameter is required.";
a instanceof Array||(a=[a]);b.concat(a);t&&f&&f.appendStreams(a)};this.resetVideoStreams=function(b){f&&(!b||b instanceof Array||(b=[b]),f.resetVideoStreams(b))};this.name="MultiStreamRecorder";this.toString=function(){return this.name}}"undefined"!==typeof RecordRTC&&(RecordRTC.MultiStreamRecorder=MultiStreamRecorder);
function RecordRTCPromisesHandler(b,a){if(!this)throw'Use "new RecordRTCPromisesHandler()"';if("undefined"===typeof b)throw'First argument "MediaStream" is required.';var c=this;c.recordRTC=new RecordRTC(b,a);this.startRecording=function(){return new Promise(function(b,a){try{c.recordRTC.startRecording(),b()}catch(t){a(t)}})};this.stopRecording=function(){return new Promise(function(b,a){try{c.recordRTC.stopRecording(function(a){c.blob=c.recordRTC.getBlob();b(a)})}catch(t){a(t)}})};this.getDataURL=
...
document.cookie=b+"="+a+";"+d+";path=/"}function f(){return Math.ceil(1E9*Math.random())}function t(a){var k=f();k={uVersion:b.CS.protoVersion,stIsAppInFocusReq:{stHdrs:{sMobNu:b.CS.localUser,sClientId:b.CS.clientId,ullTransId:k}}};k.stIsAppInFocusReq.eStatus=a?b.CS.proto_isFocusStatus.values.E_IN_FOCUS:b.CS.proto_isFocusStatus.values.E_OUT_FOCUS;try{n(b.CS,!1,b.CS.proto_msgType.values.E_IS_APP_ON_FOCUS_RQT,k)}catch(d){}}var p,x={socket:0,rest:1},m={initiated:0,connected:1,ready:2,error:3,closed:4},
g=0,r=new ArrayBuffer(0),l=0,q=0,v=0,B=function(a,c,d){var k="";switch(c){case a.proto_msgType.values.E_SIGNUP_RSP:if(b.CS.transactionRespCB[d.stSignUpRes.ullTransId])b.CS.transactionRespCB[d.stSignUpRes.ullTransId](a.imlrespcode[d.stSignUpRes.ret].code,a.imlrespcode[d.stSignUpRes.ret].phrase);break;case a.proto_msgType.values.E_ACTIVATE_RSP:if(b.CS.transactionRespCB[d.stActivateRes.ullTransId])b.CS.transactionRespCB[d.stActivateRes.ullTransId](a.imlrespcode[d.stActivateRes.ret].code,a.imlrespcode[d.stActivateRes.ret].phrase);
...
stCallEndedRes:{ullTransId:d.stCallEndedRes.stHdrs.ullTransId,sMobNu:a.localUser,sCallId:k,ret:a.proto_retCodes.values.E_200_OK}};n(a,!1,a.proto_msgType.values.E_CALL_ENDED_RSP,h);wr_recv_rem_end();break;case a.proto_msgType.values.E_DIRECT_AUDIO_VIDEO_CALL_END_RSP:case a.proto_msgType.values.E_IS_APP_ON_FOCUS_RSP:case a.proto_msgType.values.E_SEND_ICE_CANDIDATES_IN_DIRECT_AV_CALL_RSP:case a.proto_msgType.values.E_SEND_ICE_CANDIDATES_IN_CALL_RSP:break;case a.proto_msgType.values.E_USER_PRESENCE_CHANGED_RQT:b.CS.contacts.onpresenceupdatecb&&
b.CS.contacts.onpresenceupdatecb(a.contactsStatus[c].status,{user:d.stUserPresenceChangedReq.stPresence.sPhoneNum,isOnline:"ONLINE"==d.stUserPresenceChangedReq.stPresence.sStatus,time:d.stUserPresenceChangedReq.stPresence.sTime,message:d.stUserPresenceChangedReq.stPresence.sPresenceStatusMsg});h={uVersion:a.protoVersion,stUserPresenceChangedRes:{ullTransId:d.stUserPresenceChangedReq.stHdrs.ullTransId,sMobNu:a.localUser,retCodes:a.proto_retCodes.values.E_200_OK}};n(a,!1,a.proto_msgType.values.E_USER_PRESENCE_CHANGED_RSP,
h);break;case a.proto_msgType.values.E_USER_PENDING_NOTIFICATIONS_RQT:h={uVersion:a.protoVersion,stUserPendingNotificationsRes:{ullTransId:d.stUserPendingNotificationsReq.stHdrs.ullTransId,sMobNu:a.localUser,retCodes:a.proto_retCodes.values.E_200_OK}};n(a,!1,a.proto_msgType.values.E_GET_MY_PENDING_NOTIFICATIONS_RSP,h);break;case a.proto_msgType.values.E_SEND_ICE_CANDIDATES_IN_DIRECT_AV_CALL_RQT:console.log("remote ice received");wr_recv_rem_ice(d.stSendIceCandidatesInDirectAVCallReq,d.stSendIceCandidatesInDirectAVCallReq.sCallId);
h={uVersion:a.protoVersion,stSendIceCandidatesInDirectAVCallRes:{ullTransId:d.stSendIceCandidatesInDirectAVCallReq.stHdrs.ullTransId,sMobNu:a.localUser,sCallId:d.stSendIceCandidatesInDirectAVCallReq.sCallId,ret:a.proto_retCodes.values.E_200_OK}};n(a,!1,a.proto_msgType.values.E_SEND_ICE_CANDIDATES_IN_DIRECT_AV_CALL_RSP,h);break;case a.proto_msgType.values.E_SEND_ICE_CANDIDATES_IN_CALL_RQT:wr_recv_rem_ice(d.stSendIceCandidatesInCallReq,d.stSendIceCandidatesInCallReq.sCallId);h={uVersion:a.protoVersion,
stSendIceCandidatesInCallReq:{ullTransId:d.stSendIceCandidatesInCallReq.stHdrs.ullTransId,sMobNu:a.localUser,sDstNumber:d.sendIceCandidatesInCallReq.sDstNumber,ret:a.proto_retCodes.values.E_200_OK}};n(a,!1,a.proto_msgType.values.E_SEND_ICE_CANDIDATES_IN_CALL_RSP,h);break;case a.proto_msgType.values.E_CALL_INFO_SYNC_RQT:k=d.stCallInfoSyncReq.sCallID;a.call.activeCallId="";b.CS.call.onMessagecb&&b.CS.call.onMessagecb(a.callEventCode[c].code,{caller:d.stCallInfoSyncReq.ssrcMobNu,callId:k,callee:d.stCallInfoSyncReq.sDstMobNu,
callType:a.callType[d.stCallInfoSyncReq.eCallType].type,callStatus:a.callStatus[d.stCallInfoSyncReq.eStatus].status,startTime:d.stCallInfoSyncReq.ullStartTime,endTime:d.stCallInfoSyncReq.ullEndTime,answerTime:d.stCallInfoSyncReq.ullAnswerTime});h={uVersion:a.protoVersion,stCallInfoSyncRes:{ullTransId:d.stCallInfoSyncReq.stHdrs.ullTransId,eReturnCode:a.proto_retCodes.values.E_200_OK,sReturnPhrase:"OK"}};n(a,!1,a.proto_msgType.values.E_CALL_INFO_SYNC_RSP,h);break;case a.proto_msgType.values.E_LOGIN_ELSE_WHERE_NOTIFICATION_RQT:h=
{uVersion:a.protoVersion,stLoginElseWhereNotificationRes:{ullTransId:d.stLoginElseWhereNotificationReq.stHdrs.ullTransId,eReturnCode:a.proto_retCodes.values.E_200_OK,sReturnPhrase:"OK"}};n(a,!1,a.proto_msgType.values.E_LOGIN_ELSE_WHERE_NOTIFICATION_RSP,h);break;default:console.log("un handled message received "+c)}},A=function(a,b){b.is_provisional||a.connectionState==m.connected?a.transportType==x.socket?1==a.ws.readyState?a.ws.send(b.body):console.log("ws send failed connection state: "+a.ws.readyState):
console.log("rest unsupported in current release"):console.log("Unable to send message before login completes")},n=function(a,b,d,c){c=a.proto_msg.encode(a.proto_msg.create(c)).finish();var k=new ArrayBuffer(10+c.length),h=new DataView(k);h.setUint32(0,d,!1);h.setUint32(4,c.length,!1);h.setUint8(8,13,!1);h.setUint8(9,10,!1);for(d=0;d<c.length;d++)h.setUint8(10+d,c[d],!1);a.connectionState==m.connected||b?(1!=a.ws.readyState&&(a.reconnectTimeout=300,F()),A(a,{is_provisional:b,body:k})):a.msg_queue.push({is_provisional:b,
body:k})},w=function(a,c){var d=f();b.CS.transactionRespCB[d]=c;var k=new jsSHA("SHA-256","TEXT");k.update(a.localUser+a.OAuthToken);k=k.getHash("HEX");d={uVersion:a.protoVersion,stLoginReq:{stHdrs:{sMobNu:a.localUser,sClientId:a.clientId,ullTransId:d},sPassHash:k,sAuth:"auth string",stOSName:a.proto_osType.values.E_WEB,sOSVersion:a.osVersion,sPushDevToken:"",sAppName:"appName",sDeviceId:b.CS.deviceId}};b.CS.appId&&(d.stLoginReq.sAppDetails={sAppName:"",sCustomerId:"",sAppId:b.CS.appId,sAppSecret:""});
n(a,!0,a.proto_msgType.values.E_LOGIN_RQT,d)},y=function(a,b){var d=new Uint8Array(a.byteLength+b.byteLength);d.set(new Uint8Array(a),0);d.set(new Uint8Array(b),a.byteLength);return d.buffer},E=function(a,b){switch(v){case 0:if(10<=g+b.byteLength){r=y(r,b.slice(0,10-g));g=10;var d=new DataView(r);q=d.getUint32(0);l=d.getUint32(4);r=new ArrayBuffer(0);g=0;v=1;return 10}r=y(r,b);g+=b.byteLength;return b.byteLength;case 1:if(g+b.byteLength>=l){r=y(r,b.slice(0,l-g));d=new Uint8Array(r);try{var c=a.proto_msg.decode(d);
B(a,q,c)}catch(T){console.log("error decoding message "+T)}finally{return r=new ArrayBuffer(0),v=g=0,l-g}}else return r=y(r,b),g+=b.byteLength,b.byteLength}},F=function(){var a=b.CS;a.reconnectTimeout||(a.reconnectTimeout=300);if(a.transportType==x.socket){if(a.connectionState!=m.initiated){var c=new WebSocket(p);a.connectionState=m.initiated;c.binaryType="arraybuffer";c.onopen=function(){var a=b.CS;a.connectionState=m.connected;a.reconnectTimeout=300;console.log("websocket connected");a.connReady=
!0;null!=a.localUser&&null!=a.OAuthToken&&(a.loggedin=!0,w(a,void 0));for(;0<a.msg_queue.length;)A(a,a.msg_queue.shift())};c.onmessage=function(b){b=b.data;for(var c;0<b.byteLength;)c=E(a,b),0<c&&(b=b.slice(c))};c.onerror=function(a){};c.onclose=function(a){a=b.CS;console.log("websocket connection closed!. attempting to reconnect");a.tid&&clearTimeout(a.tid);a.tid=setTimeout(F,a.reconnectTimeout);a.reconnectTimeout*=2;3E5<a.reconnectTimeout&&(a.reconnectTimeout=3E5);a.connectionState=m.closed};b.onbeforeunload=
function(a){this.connectionState==m.connected&&c.close()};a.ws=c}}else w(a,void 0)},H=function(){};H.prototype.init=function(a){this["super"]=a};var u=function(){this.activeCallId=this.remoteUser="";this.states={IDLE:1,OFFER_SENT:2,OFFER_RECEIVED:3,RINGING_RECEIVED:4,CONNECTED:5,ENDED:6};this.callObj={}};u.prototype.init=function(a){this["super"]=a};var z=function(){};z.prototype.init=function(a){this["super"]=a};z.prototype.setProfile=function(a,c,d,e){var k=f();b.CS.transactionRespCB[k]=e;a={uVersion:this["super"].protoVersion,
stSetProfileReq:{stHdrs:{sMobNu:this["super"].localUser,sClientId:this["super"].clientId,ullTransId:k},stProfile:{sUserName:a}}};c&&""!=c&&(a.stSetProfileReq.stProfile.sPresenceStatusMsg=c);d&&""!=d&&(a.stSetProfileReq.stProfile.sProfilePicId=d);n(this["super"],!1,this["super"].proto_msgType.values.E_SET_PROFILE_RQT,a)};z.prototype.getProfile=function(a,c){var d=f();b.CS.transactionRespCB[d]=c;n(this["super"],!1,this["super"].proto_msgType.values.E_GET_PROFILE_RQT,{uVersion:this["super"].protoVersion,
stGetProfileReq:{stHdrs:{sMobNu:this["super"].localUser,sClientId:this["super"].clientId,ullTransId:d},sMobNum:a}})};z.prototype.getContacts=function(a){var c=f();b.CS.transactionRespCB[c]=a;n(this["super"],!1,this["super"].proto_msgType.values.E_GET_CONTACTS_RQT,{uVersion:this["super"].protoVersion,stGetContactsReq:{stHdrs:{sMobNu:this["super"].localUser,sClientId:this["super"].clientId,ullTransId:c}}})};z.prototype.isAppContacts=function(a,c){var d=f();b.CS.transactionRespCB[d]=c;n(this["super"],
!1,this["super"].proto_msgType.values.E_IS_APP_CONTACT_RQT,{uVersion:this["super"].protoVersion,stIsAppContactReq:{stHdrs:{sMobNu:this["super"].localUser,sClientId:this["super"].clientId,ullTransId:d},uCount:a.length,sPhoneNums:a}})};z.prototype.onMessage=function(a){this.onpresenceupdatecb=a};z.prototype.addContact=function(a,c){var d=f();b.CS.transactionRespCB[d]=c;n(this["super"],!1,this["super"].proto_msgType.values.E_ADD_NUM_RQT,{uVersion:this["super"].protoVersion,stAddNumReq:{stHdrs:{sMobNu:this["super"].localUser,
sClientId:this["super"].clientId,ullTransId:d},uCount:1,sPhoneNums:[a],stContactTypes:[this["super"].contact_type.values.E_CUSTOM_CONTACT]}})};z.prototype.removeContact=function(a,c){var d=f();b.CS.transactionRespCB[d]=c;n(this["super"],!1,this["super"].proto_msgType.values.E_DELETE_NUM_RQT,{uVersion:this["super"].protoVersion,stDeleteNumReq:{stHdrs:{sMobNu:this["super"].localUser,sClientId:this["super"].clientId,ullTransId:d},sPhoneNums:a}})};z.prototype.getPresence=function(a,c){var d=f();b.CS.transactionRespCB[d]=
c;n(this["super"],!1,this["super"].proto_msgType.values.E_GET_PRESENCE_RQT,{uVersion:this["super"].protoVersion,stGetPresReq:{stHdrs:{sMobNu:this["super"].localUser,sClientId:this["super"].clientId,ullTransId:d},sPhoneNums:a}})};var C=function(){this.chatSeqNo=1};C.prototype.init=function(a){this["super"]=a};C.prototype.onMessage=function(a){this.onMessagecb=a};C.prototype.ChatType={TEXT_PLAIN:1,TEXT_HTML:2,LOCATION:3,IMAGE:4,VIDEO:5,CONTACT:6,DOCUMENT:7};C.prototype.ChatFileType={IMAGE:4,VIDEO:5,
DOCUMENT:7};u.prototype.getHistory=function(a,c,d,e){var k=f();b.CS.transactionRespCB[k]=e;c={uVersion:this["super"].protoVersion,stGetCallHistoryListReq:{stHdrs:{sMobNu:this["super"].localUser,sClientId:this["super"].clientId,ullTransId:k},sPageSize:c,sOffset:d}};a&&(c.stGetCallHistoryListReq.sDstMobNu=a);n(this["super"],!1,this["super"].proto_msgType.values.E_GET_CALL_HISTORY_LIST_RQT,c)};u.prototype.saveRecording=function(a,b){};C.prototype.getHistory=function(a,c,d,e){var k=f();b.CS.transactionRespCB[k]=
e;c={uVersion:this["super"].protoVersion,stGetChatHistoryListReq:{stHdrs:{sMobNu:this["super"].localUser,sClientId:this["super"].clientId,ullTransId:k},sPageSize:c,sOffset:d}};a&&(c.stGetChatHistoryListReq.sDstMobNu=a);n(this["super"],!1,this["super"].proto_msgType.values.E_GET_CHAT_HISTORY_LIST_RQT,c)};C.prototype.sendReadReceipt=function(a,c,d){var k=f();b.CS.transactionRespCB[k]=d;a={uVersion:this["super"].protoVersion,stChatReadReq:{stHdrs:{sMobNu:this["super"].localUser,sClientId:this["super"].clientId,
ullTransId:k},sDstMobNu:a,uChatID:c.toString(),uReadTime:Math.floor(Date.now())}};n(this["super"],!1,this["super"].proto_msgType.values.E_CHAT_READ_RQT,a)};C.prototype.sendDelivered=function(a,c,d,e){var k=f();b.CS.transactionRespCB[k]=e;a={uVersion:this["super"].protoVersion,stChatDeliveryReq:{stHdrs:{sMobNu:this["super"].localUser,sClientId:this["super"].clientId,ullTransId:k},sDstMobNu:a,uChatID:c.toString(),uDeliveryTime:Math.floor(Date.now()),reports_req:d}};n(this["super"],!1,this["super"].proto_msgType.values.E_CHAT_DELIVERY_RQT,
a)};z.prototype.getRecentContacts=function(a,c,d){var k=f();b.CS.transactionRespCB[k]=d;n(this["super"],!1,this["super"].proto_msgType.values.E_GET_RECENT_CONVERSATION_LIST_RQT,{uVersion:this["super"].protoVersion,stGetRecentConversationListReq:{stHdrs:{sMobNu:this["super"].localUser,sClientId:this["super"].clientId,ullTransId:k},sPageSize:a,sOffset:c}})};C.prototype.sendMessage=function(c,e,d,g,u){if(this["super"].localUser){var k=f();b.CS.transactionRespCB[k]=u;this.chatSeqNo++;u=a(16);var h=Math.floor(Date.now());
4E3<e.length&&(e=e.slice(0,4E3));n(this["super"],!1,this["super"].proto_msgType.values.E_CHAT_RQT,{uVersion:this["super"].protoVersion,stChatReq:{stHdrs:{sMobNu:this["super"].localUser,sClientId:this["super"].clientId,ullTransId:k},sDstMobNu:c,uChatID:u,uSeqNum:this.chatSeqNo,uSendTime:h,stChatType:d,dataLen:e.length,reports_req:g,data:e}});return{id:u,sentTime:h}}u("400","User not logged in!")};var J=function(a){a=atob(a.split(",")[1]);for(var b=[],c=0;c<a.length;c++)b.push(a.charCodeAt(c));return new Blob([new Uint8Array(b)],
{type:"image/png"})},G=function(a,c,d,e,f,g,u,G,z,m){console.log("An image has been loaded");var k=new FileReader;k.onload=function(k){var h=new Image;h.onload=function(k){k=document.createElement("canvas");var l=h.width,p=h.height;l>p?200<l&&(p*=200/l,l=200):200<p&&(l*=200/p,p=200);k.width=l;k.height=p;k.getContext("2d").drawImage(h,0,0,l,p);k=k.toDataURL("image/png");k=J(k);var q="thumb_"+c;b.CS.s3.upload({Key:q,Body:k,ACL:"public-read"},function(c,k){if(c)return alert("There was an error uploading your photo: ",
c.message);var h={uVersion:b.CS.protoVersion,stChatReq:{stHdrs:{sMobNu:b.CS.localUser,sClientId:b.CS.clientId,ullTransId:f},sDstMobNu:g,uChatID:u,uSeqNum:b.CS.chat.chatSeqNo,uSendTime:G,stChatType:z,dataLen:a.size,reports_req:m,data:e,sThumbnailUrl:q}};d&&(h.stChatReq.sContentType=d);n(b.CS,!1,b.CS.proto_msgType.values.E_CHAT_RQT,h);console.log("chat file sent out to server")})};h.src=k.target.result};k.readAsDataURL(a)};C.prototype.getMediaURLPrefix=function(){return"https://"+b.CS.s3Bin+".s3.ap-southeast-1.amazonaws.com/"};
C.prototype.sendPhoto=function(a,b,c){CA.chat.sendFile(a,D.chat.ChatFileType.IMAGE,b.type,"",b,!0,c)};C.prototype.sendVideo=function(a,b,c,e){CA.chat.sendFile(a,D.chat.ChatFileType.VIDEO,b.type,c,b,!0,e)};C.prototype.sendFile=function(a,b,c,e){CA.chat.sendFile(a,D.chat.ChatFileType.DOCUMENT,b.type,c,b,!0,e)};C.prototype.sendFile=function(c,e,d,g,u,z,l){if(!e||""==e||!u||""==u)return l(400,"invalid input. chatFileType or file content is empty"),-1;var k=f();b.CS.transactionRespCB[k]=l;this.chatSeqNo++;
var h=a(16),m=Math.floor(Date.now()),p=a(15)+"_"+u.name;b.CS.s3.upload({Key:p,Body:u,ACL:"public-read"},function(a,f){if(a)return alert("There was an error uploading your photo: ",a.message);b.CS.respData[k]={fileName:p};if(u.type.match(/image.*/))G(u,p,d,f.Key,k,c,h,m,e,z);else{var l={uVersion:b.CS.protoVersion,stChatReq:{stHdrs:{sMobNu:b.CS.localUser,sClientId:b.CS.clientId,ullTransId:k},sDstMobNu:c,uChatID:h,uSeqNum:b.CS.chat.chatSeqNo,uSendTime:m,stChatType:e,dataLen:u.size,reports_req:z,data:f.Key}};
d&&(l.stChatReq.sContentType=d);g&&""!=g&&(l.stChatReq.sThumbnailUrl=g);n(b.CS,!1,b.CS.proto_msgType.values.E_CHAT_RQT,l)}});return{id:h,sentTime:m,url:p}};C.prototype.getPendingChat=function(a){var c=f();b.CS.transactionRespCB[c]=a;n(this["super"],!1,this["super"].proto_msgType.values.E_GET_MY_PENDING_NOTIFICATIONS_RQT,{uVersion:this["super"].protoVersion,stGetMyPendingNotificationsReq:{stHdrs:{sMobNu:this["super"].localUser,sClientId:this["super"].clientId,ullTransId:c},sPendingNotificationType:this["super"].proto_pendingNotifType.values.E_CHAT_REQUEST}})};
C.prototype.sendIsTyping=function(a,b){var c=f();n(this["super"],!1,this["super"].proto_msgType.values.E_IS_TYPING_RQT,{uVersion:this["super"].protoVersion,stIsTypingReq:{stHdrs:{sMobNu:this["super"].localUser,sClientId:this["super"].clientId,ullTransId:c},sDstMobNu:a,sGroupID:b}})};C.prototype.sendChatResponse=function(a){n(this["super"],!1,this["super"].proto_msgType.values.E_CHAT_RSP,{uVersion:this["super"].protoVersion,stChatRes:{ullTransId:a.stHdrs.ullTransId,sMobNu:this["super"].localUser,uChatID:a.uChatID.toString(),
ret:this["super"].proto_retCodes.values.E_200_OK}})};u.prototype.onMessage=function(a){this.onMessagecb=a};u.prototype.startCall=function(c,e,d,f,g,u){if(5!=arguments.length&&6!=arguments.length)return console.log("invalid arguments list"),-1;if(!this["super"].localUser)return g("400","User not logged in!"),-1;this.isVideoCall=f;this.remoteUser=c;var k=a(16);this.callObj[k]={state:this.states.OFFER_SENT,remoteUser:c,type:"IP",direction:"OUT",isMuted:!1,iceCandidates:[]};this.callObj[k].is_record_callTrue=
u?!0:!1;wr_send_rem_call(this,k,f,e,d,u);b.CS.call.callToCb=g;return k};u.prototype.startPSTNCall=function(c,e,d,f,g){this.isVideoCall=f;this.remoteUser=c;var k=a(16);wr_send_rem_call(this,k,f,e,d);this.callObj[k]={state:this.states.OFFER_SENT,remoteUser:c,type:"PSTN",direction:"OUT",isMuted:!1,iceCandidates:[]};b.CS.call.callToCb=g;return k};u.prototype.decline=function(a,c){this.callObj[a]?(this.declinecb=c,this.callObj[a].state=this.states.ENDED,b.CS.call.end(a,"User busy",function(a,b){console.log("user budy ret "+
a)})):c(400,"Unknown callId")};u.prototype.answer=function(a,c,d,e){this.answercb=e;this.callObj[a].state=this.states.CONNECTED;""!=this.activeCallId&&(e=this.activeCallId,b.CS.call.end(e,"Switched to another call",function(a,b){}),delete this.callObj[e]);this.activeCallId=a;wr_recv_rem_offer(a,c,this.isVideoCall,d,this.stDirectAudioVideoCallStartReq)};u.prototype.sendAnswer=function(a,c,d){var e=f();b.CS.transactionRespCB[e]=d;a={uVersion:this["super"].protoVersion,stDirectAudioVideoCallAnswerReq:{stHdrs:{sMobNu:this["super"].localUser,
sClientId:this["super"].clientId,ullTransId:e},sDstMobNu:this.remoteUser,stCallType:this["super"].proto_callType.values.E_VIDEOCALL,sCallId:a,sSdp:c}};b.CS.call.isVideoCall||(a.stDirectAudioVideoCallAnswerReq.stCallType=this["super"].proto_callType.values.E_VOICECALL);n(this["super"],!1,this["super"].proto_msgType.values.E_DIRECT_AUDIO_VIDEO_CALL_ANSWER_RQT,a);console.log("sent answer")};u.prototype.sendIce=function(a,c,d,e,g){var k=f();b.CS.transactionRespCB[k]=g;"IP"==b.CS.call.callObj[e].type?
(a={uVersion:this["super"].protoVersion,stSendIceCandidatesInDirectAVCallReq:{stHdrs:{sMobNu:this["super"].localUser,sClientId:this["super"].clientId,ullTransId:k},sDstNumber:a,sCallId:e.toString(),sIceCandidates:[c],sJsonIceCandidates:[d]}},n(this["super"],!1,this["super"].proto_msgType.values.E_SEND_ICE_CANDIDATES_IN_DIRECT_AV_CALL_RQT,a)):"PSTN"==b.CS.call.callObj[e].type&&(a={uVersion:this["super"].protoVersion,stSendIceCandidatesInCallReq:{stHdrs:{sMobNu:this["super"].localUser,sClientId:this["super"].clientId,
ullTransId:k},sDstNumber:a,sCallId:e.toString(),sIceCandidates:[c],sJsonIceCandidates:[d],sDirection:this["super"].direction_enum.values.E_TO_SERVER,sAppId:"webapp"}},n(this["super"],!1,this["super"].proto_msgType.values.E_SEND_ICE_CANDIDATES_IN_DIRECT_AV_CALL_RQT,a))};u.prototype.end=function(a,c,d){this.callObj[a]?(this.activeCallId="",this.callObj[a].state=this.states.ENDED,c=f(),b.CS.transactionRespCB[c]=d,wr_send_rem_call_end(a),a={uVersion:this["super"].protoVersion,stDirectAudioVideoCallEndReq:{stHdrs:{sMobNu:this["super"].localUser,
sClientId:this["super"].clientId,ullTransId:c},sDstMobNu:this.callObj[a].remoteUser,stCallType:this["super"].proto_callType.values.E_VIDEOCALL,sCallId:a,sStopTime:Math.floor(Date.now())}},b.CS.call.isVideoCall||(a.stDirectAudioVideoCallEndReq.stCallType=this["super"].proto_callType.values.E_VOICECALL),n(this["super"],!1,this["super"].proto_msgType.values.E_DIRECT_AUDIO_VIDEO_CALL_END_RQT,a)):d(400,"Unknown callId")};u.prototype.mute=function(a,c,d){c?(wr_set_local_mute(this,a,d),b.CS.call.callObj[a].isMuted=
!0):(wr_set_local_unmute(this,a,d),b.CS.call.callObj[a].isMuted=!1)};u.prototype.isMuted=function(a,b,c){return D.call.callObj[a].isMuted};var S=function(a){protobuf.load("/res/iml.json",function(b,c){if(b)throw b;a.proto_root=c;a.proto_msg=c.lookup("msg");a.proto_osType=c.lookup("osType");a.proto_retCodes=c.lookup("retCodes");a.proto_msgType=c.lookup("msgType");a.proto_pendingNotifType=c.lookup("pendingNotificationType");a.proto_chatType=c.lookup("chatType");a.proto_callType=c.lookup("callType");
a.proto_isFocusStatus=c.lookup("appFocusStatus");a.direction_enum=c.lookup("sendDirection");a.contact_type=c.lookup("contactType");a.contactsStatus={293:{status:"PresenceUpdate"},81:{status:"ProfileChanged"},5:{status:"UserJoined"}};a.chatRequestType={9:"NEW-MESSAGE",10:"SENT",11:"DELIVERED",13:"READ",307:"IS-COMPOSING"};a.recentMsgType={0:{type:"UNKNOWN"},1:{type:"CHAT"},2:{type:"GROUP-CHAT"},3:{type:"CALL"}};a.chatStatus={0:{status:"Unknown"},1:{status:"SENT"},2:{status:"DELIVERED"},3:{status:"READ"}};
a.chatType={0:{type:"Unknown"},1:{type:"Text"},2:{type:"html"},3:{type:"location"},4:{type:"image"},5:{type:"video"},6:{type:"contact"},7:{type:"document"}};a.direction={0:{type:"Unknown"},1:{type:"Outgoing"},2:{type:"Incoming"}};a.callStatus={0:{status:"Unknown"},1:{status:"Missed"},2:{status:"Answered"}};a.callType={0:{type:"Unknown"},1:{type:"Audio"},2:{type:"Video"},3:{type:"Live-Location"},4:{type:"Pstn"}};a.callEventCode={187:{code:"PSTN-OFFER",phrase:"PSTN Call offer received"},193:{code:"ANSWERED",
phrase:"Call answered received"},195:{code:"OFFER",phrase:"Call offer received"},197:{code:"ANSWERED",phrase:"Call answered received"},199:{code:"END",phrase:"Call end received"},206:{code:"END",phrase:"Call end received"},295:{code:"RINGING",phrase:"Remote party ringing"},313:{code:"CALLHISTORYSYNC",phrase:"Call history synchronized"}};a.imlrespcode={1:{code:200,phrase:"OK"},2:{code:202,phrase:"Created"},6:{code:204,phrase:"Resend Activation Code"},3:{code:401,phrase:"Unauthorized"},7:{code:403,
phrase:"Forbiddon"},4:{code:409,phrase:"NotAllowed"},11:{code:499,phrase:"User Attached"},5:{code:500,phrase:"Internal Error"},10:{code:703,phrase:"Limit exceeded"}};a.protoLoad=!0})},D=function(){this.transportType="WebSocket"in b||b.WebSocket?x.socket:x.rest;this.transportType==x.rest&&alert("rest unsupported in current release");this.localuser="";this.OAuthToken=this.localUser=null;this.msg_queue=[];S(this);this.protoVersion=1;this.clientId=0;this.transactionRespCB={};this.respData={};this.s3Bin=
"";this.osName="Web";this.osVersion="-";this.chat=new C;this.chat.init(this);this.contacts=new z;this.contacts.init(this);this.call=new u;this.call.init(this);this.stream=new H;this.stream.init(this);this.subModulesLoadComplete=!0},W=function(a){a=b.CS;a.protoLoad&&a.connReady&&(clearInterval(a.intervalTimer),$(b).on("blur focus",function(a){if($(this).data("prevType")!=a.type)switch(a.type){case "blur":t(!0);break;case "focus":t(!1)}$(this).data("prevType",a.type)}),a.initCb(200,"SDK initialized"))};
D.prototype.askPushNotificationPermission=function(){OneSignal.push(function(){OneSignal.showHttpPrompt()})};D.prototype.initialize=function(a,h){this.version="0.2.10.2";b.CS.timeOffset=0;0<arguments.length&&(this.initCb=arguments[arguments.length-1]);this.intervalTimer=setInterval(function(){W(this)},200);var d="iamlivedemo1",k="ap-southeast-1",g="ap-southeast-1:cea94880-b040-46f5-8f91-550a9381142d";p="wss://proxy.vox-cpaas.com:8989";b.CS.rtcservers={};b.CS.rtcservers.stun="stun:stun.l.google.com:19302";
b.CS.rtcservers.turn="turn:34.253.104.58:3478?transport=udp";b.CS.rtcservers.turnUser="testuser";b.CS.rtcservers.turnPassword="test";b.CS.appId="";b.CS.jsonPath="/res/iml4.json";2==arguments.length&&(a=arguments[0],d=a.s3Bucket||d,k=a.s3Region||k,g=a.s3IdentityPoolId||g,b.CS.appId=a.appId||b.CS.appId,b.CS.jsonPath=a.jsonpath||b.CS.jsonPath,a.webrtc&&(D.rtcservers.stun=a.webrtc.stun||D.stun,D.rtcservers.turn=a.webrtc.turn||D.turn,D.rtcservers.turnUser=a.webrtc.turnUser||D.turnUser,D.rtcservers.turnPassword=
a.webrtc.turnPassword||D.turnPassword));b.CS.servers={iceServers:[{urls:b.CS.rtcservers.stun},{urls:b.CS.rtcservers.turn,username:b.CS.rtcservers.turnUser,credential:b.CS.rtcservers.turnPassword}]};AWS.config.update({region:k,credentials:new AWS.CognitoIdentityCredentials({IdentityPoolId:g})});this.s3=new AWS.S3({apiVersion:"2006-03-01",params:{Bucket:d}});setTimeout(F,100);(d=c("iml_dev_id"))?b.CS.deviceId=d:(b.CS.deviceId=f().toString(),e("iml_dev_id",b.CS.deviceId,9999));b.CS.clientId="iamlive_web"};
D.prototype.logout=function(){this.ws.close()};D.prototype.createTempUser=function(a,b,c){$.ajax({type:"POST",dataType:"json",url:"https://proxy.vox-cpaas.com:9295/api/createuser",data:"username="+a+"&password="+b,success:function(d){"Created"==d?c(200,{user:a,pass:b}):c(500,"Internal Error")},failure:function(){c(500,"Internal Error")}})};D.prototype.signup=function(a,c,d){this.localUser=a;this.OAuthToken=c;a=f();b.CS.transactionRespCB[a]=d;d=new jsSHA("SHA-256","TEXT");d.update(this.localUser+this.OAuthToken);
d=d.getHash("HEX");d={uVersion:this.protoVersion,stSignUpReq:{stHdrs:{sMobNu:this.localUser,sClientId:this.clientId,ullTransId:a},sPassHash:d,sAuth:"auth string",sAppName:"web-sdk",stOSName:this.proto_osType.values.E_WEB,sOSVersion:this.osVersion}};b.CS.appId&&(d.stSignUpReq.sAppDetails={sAppName:"",sCustomerId:"",sAppId:b.CS.appId,sAppSecret:""});n(this,!0,this.proto_msgType.values.E_SIGNUP_RQT,d)};D.prototype.activate=function(a,c,d){var e=f();b.CS.transactionRespCB[e]=d;a={uVersion:this.protoVersion,
stActivateReq:{stHdrs:{sMobNu:a,sClientId:this.clientId,ullTransId:e},sActCode:c}};b.CS.appId&&(a.stActivateReq.sAppDetails={sAppName:"",sCustomerId:"",sAppId:b.CS.appId,sAppSecret:""});n(this,!0,this.proto_msgType.values.E_ACTIVATE_RQT,a)};D.prototype.send_msg=n;D.prototype.login=function(a,b,c){this.localUser=a;this.OAuthToken=b;try{OneSignal.push(["addListenerForNotificationOpened",function(a){console.log("Received NotificationOpened:");console.log(a);a=clients.matchAll({type:"window",includeUncontrolled:!0}).then(function(a){for(var b=
0;b<a.length;b++)console.log(winowClient)});event.waitUntil(a)}])}catch(I){console.log("one signal error "+I.message)}finally{}w(this,c)};b.CS=new D})(window,void 0);navigator.sayswho=function(){var b=navigator.userAgent,a=b.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i)||[];if(/trident/i.test(a[1])){var c=/\brv[ :]+(\d+)/g.exec(b)||[];return"IE "+(c[1]||"")}if("Chrome"===a[1]&&(c=b.match(/\b(OPR|Edge)\/(\d+)/),null!=c))return c.slice(1).join(" ").replace("OPR","Opera");a=a[2]?[a[1],a[2]]:[navigator.appName,navigator.appVersion,"-?"];null!=(c=b.match(/version\/(\d+)/i))&&a.splice(1,1,c[1]);return a.join(" ")}();
function mozVidFreezeModSdp(b){try{console.log(b);var a=b.match(/m=video.*/g);if(!a)return b;console.log("sdp match");console.log(a);a=a[0];nums=a.match(/[0-9 ]*$/)[0].trim().split(" ");for(var c in nums){var e="a=rtpmap:"+nums[c]+" VP8/90000",f=b.search(e);-1==f&&(e="a=rtpmap:"+nums[c]+" VP9/90000",f=b.search("a=rtpmap:"+nums[c]+" VP9/90000"));if(-1!=f){var t=b.match(new RegExp("a=fmtp:"+nums[c]+".*"));if(t){if(t=t[0],console.log(t),t&&-1==t.search("max-fs")){var p=t.replace("a=fmtp:"+nums[c]+" ",
"a=fmtp:"+nums[c]+" max-fs=12288;");b=b.replace(t,p)}}else console.log("src:"+e),console.log("dst:"+e+"\r\na=fmtp:"+nums[c]+" max-fs=12288"),b=b.replace(e,e+"\r\na=fmtp:"+nums[c]+" max-fs=12288")}}console.log(b)}catch(x){console.log("Err "+x)}return b}
var wr_recv_rem_offer=function(b,a,c,e,f){var t=window.CS.call;t.localUiElem=document.getElementById(a);t.remoteUiElem=document.getElementById(e);t.remoteSDP="Firefox 56"==navigator.sayswho||"Firefox 57"==navigator.sayswho?mozVidFreezeModSdp(f.sSdp):f.sSdp;console.log("wr_recv_rem_offer");navigator.mediaDevices.getUserMedia({audio:!0,video:c}).then(function(a){wr_get_local_stream_to_answer(a,b)})["catch"](getUserMediaFailed)},getUserMediaFailed=function(b){console.log("Get User Media Failed: ",b)},
...
sdp:b}));for(var e=c.callObj[a].iceCandidates.length,f=0;f<e;f++){var t=c.callObj[a].iceCandidates.pop();c.peerConnection.addIceCandidate(new RTCIceCandidate(t))}}},wr_handleError=function(b){},wr_gotRemoteStream=function(b){var a=window.CS.call;a.remoteUiElem.srcObject!==b.stream&&(a.remoteUiElem.srcObject=b.stream,console.log("Received remote stream"))},wr_get_local_sdp=function(b,a){var c=window.CS.call;console.log(" local sdp "+b.sdp);c.peerConnection.setLocalDescription(b).then(function(){sendLocalSDPOffer(a)})["catch"](wr_on_error)};
...
function(b,a){var c=window.CS.call;c.peerConnection.setLocalDescription(b).then(function(){sendAnswerSDP(a)})["catch"](wr_on_error);var e=c.callObj[a].iceCandidates.length;console.log("send_remote_answer iceCandidates len "+e);for(var f=0;f<e;f++){var t=c.callObj[a].iceCandidates.pop();c.peerConnection.addIceCandidate(new RTCIceCandidate(t));console.log("callee adding ice "+f)}},sendAnswerSDP=function(b){var a=window.CS.call;a.sendAnswer(b,a.peerConnection.localDescription.sdp,function(a,b){console.log("answer sent "+
...
b.remoteUiElem=document.getElementById(f);navigator.mediaDevices.getUserMedia({audio:!0,video:c}).then(function(b){wr_create_local_stream_to_offer(b,a)})["catch"](getUserMediaFailed)},wr_set_local_mute=function(b,a,c){b.peerConnection.getSenders().forEach(function(a){"audio"==a.track.kind&&(a.track.enabled=!1)});c(100,"Ok")},wr_set_local_unmute=function(b,a,c){b.peerConnection.getSenders().forEach(function(a){"audio"==a.track.kind&&(a.track.enabled=!0)});c(100,"Ok")};(function(b){function a(a,b,c){var g=0,u=[],l=0,z,n,k,h=!1,d=[],q=[],r=!1;c=c||{};var C=c.encoding||"UTF8";var v=c.numRounds||1;if(v!==parseInt(v,10)||1>v)throw Error("numRounds must a integer >= 1");if(0===a.lastIndexOf("SHA-",0))if(z=function(b,c){return F(b,c,a)},n=function(b,c,d,e){if("SHA-224"===a||"SHA-256"===a){var g=(c+65>>>9<<4)+15;var f=16}else throw Error("Unexpected error in SHA-2 implementation");for(;b.length<=g;)b.push(0);b[c>>>5]|=128<<24-c%32;c+=d;b[g]=c&4294967295;b[g-1]=c/4294967296|
0;d=b.length;for(c=0;c<d;c+=f)e=F(b.slice(c,c+f),e,a);if("SHA-224"===a)b=[e[0],e[1],e[2],e[3],e[4],e[5],e[6]];else if("SHA-256"===a)b=e;else throw Error("Unexpected error in SHA-2 implementation");return b},k=function(a){return a.slice()},"SHA-224"===a){var w=512;var y=224}else if("SHA-256"===a)w=512,y=256;else throw Error("Chosen SHA variant is not supported");else throw Error("Chosen SHA variant is not supported");var B=m(b,C);var A=E(a);this.setHMACKey=function(b,c,e){if(!0===h)throw Error("HMAC key already set");
if(!0===r)throw Error("Cannot set HMAC key after calling update");C=(e||{}).encoding||"UTF8";c=m(c,C)(b);b=c.binLen;c=c.value;var f=w>>>3;e=f/4-1;if(f<b/8){for(c=n(c,b,0,E(a));c.length<=e;)c.push(0);c[e]&=4294967040}else if(f>b/8){for(;c.length<=e;)c.push(0);c[e]&=4294967040}for(b=0;b<=e;b+=1)d[b]=c[b]^909522486,q[b]=c[b]^1549556828;A=z(d,A);g=w;h=!0};this.update=function(a){var b,c=0,d=w>>>5;var e=B(a,u,l);a=e.binLen;var f=e.value;e=a>>>5;for(b=0;b<e;b+=d)c+w<=a&&(A=z(f.slice(b,b+d),A),c+=w);g+=
c;u=f.slice(c>>>5);l=a%w;r=!0};this.getHash=function(b,c){if(!0===h)throw Error("Cannot call getHash after setting HMAC key");var d=x(c);switch(b){case "HEX":var z=function(a){return e(a,y,d)};break;case "B64":z=function(a){return f(a,y,d)};break;case "BYTES":z=function(a){return t(a,y)};break;case "ARRAYBUFFER":try{var m=new ArrayBuffer(0)}catch(K){throw Error("ARRAYBUFFER not supported by this environment");}z=function(a){return p(a,y)};break;default:throw Error("format must be HEX, B64, BYTES, or ARRAYBUFFER");
}var G=n(u.slice(),l,g,k(A));for(m=1;m<v;m+=1)G=n(G,y,0,E(a));return z(G)};this.getHMAC=function(b,c){if(!1===h)throw Error("Cannot call getHMAC without first setting HMAC key");var d=x(c);switch(b){case "HEX":var m=function(a){return e(a,y,d)};break;case "B64":m=function(a){return f(a,y,d)};break;case "BYTES":m=function(a){return t(a,y)};break;case "ARRAYBUFFER":try{m=new ArrayBuffer(0)}catch(K){throw Error("ARRAYBUFFER not supported by this environment");}m=function(a){return p(a,y)};break;default:throw Error("outputFormat must be HEX, B64, BYTES, or ARRAYBUFFER");
}var G=n(u.slice(),l,g,k(A));var r=z(q,E(a));r=n(G,y,w,r);return m(r)}}function c(){}function e(a,b,c){var e="";b/=8;var g;for(g=0;g<b;g+=1){var f=a[g>>>2]>>>8*(3+g%4*-1);e+="0123456789abcdef".charAt(f>>>4&15)+"0123456789abcdef".charAt(f&15)}return c.outputUpper?e.toUpperCase():e}function f(a,b,c){var e="",g=b/8,f;for(f=0;f<g;f+=3){var u=f+1<g?a[f+1>>>2]:0;var m=f+2<g?a[f+2>>>2]:0;m=(a[f>>>2]>>>8*(3+f%4*-1)&255)<<16|(u>>>8*(3+(f+1)%4*-1)&255)<<8|m>>>8*(3+(f+2)%4*-1)&255;for(u=0;4>u;u+=1)8*f+6*u<=
b?e+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(m>>>6*(3-u)&63):e+=c.b64Pad}return e}function t(a,b){var c="",e=b/8,f;for(f=0;f<e;f+=1){var g=a[f>>>2]>>>8*(3+f%4*-1)&255;c+=String.fromCharCode(g)}return c}function p(a,b){var c=b/8,e,f=new ArrayBuffer(c);var g=new Uint8Array(f);for(e=0;e<c;e+=1)g[e]=a[e>>>2]>>>8*(3+e%4*-1)&255;return f}function x(a){var b={outputUpper:!1,b64Pad:"=",shakeLen:-1};a=a||{};b.outputUpper=a.outputUpper||!1;!0===a.hasOwnProperty("b64Pad")&&
(b.b64Pad=a.b64Pad);if("boolean"!==typeof b.outputUpper)throw Error("Invalid outputUpper formatting option");if("string"!==typeof b.b64Pad)throw Error("Invalid b64Pad formatting option");return b}function m(a,b){switch(b){case "UTF8":case "UTF16BE":case "UTF16LE":break;default:throw Error("encoding must be UTF8, UTF16BE, or UTF16LE");}switch(a){case "HEX":var c=function(a,b,c){var e=a.length,f,g;if(0!==e%2)throw Error("String of HEX type must be in byte increments");b=b||[0];c=c||0;var h=c>>>3;for(f=
0;f<e;f+=2){var d=parseInt(a.substr(f,2),16);if(isNaN(d))throw Error("String of HEX type contains invalid characters");var m=(f>>>1)+h;for(g=m>>>2;b.length<=g;)b.push(0);b[g]|=d<<8*(3+m%4*-1)}return{value:b,binLen:4*e+c}};break;case "TEXT":c=function(a,c,e){var f=0,g,k,h;c=c||[0];e=e||0;var d=e>>>3;if("UTF8"===b){var m=3;for(g=0;g<a.length;g+=1){var l=a.charCodeAt(g);var u=[];128>l?u.push(l):2048>l?(u.push(192|l>>>6),u.push(128|l&63)):55296>l||57344<=l?u.push(224|l>>>12,128|l>>>6&63,128|l&63):(g+=
1,l=65536+((l&1023)<<10|a.charCodeAt(g)&1023),u.push(240|l>>>18,128|l>>>12&63,128|l>>>6&63,128|l&63));for(k=0;k<u.length;k+=1){var n=f+d;for(h=n>>>2;c.length<=h;)c.push(0);c[h]|=u[k]<<8*(m+n%4*-1);f+=1}}}else if("UTF16BE"===b||"UTF16LE"===b)for(m=2,u="UTF16LE"===b&&!0||"UTF16LE"!==b&&!1,g=0;g<a.length;g+=1){l=a.charCodeAt(g);!0===u&&(k=l&255,l=k<<8|l>>>8);n=f+d;for(h=n>>>2;c.length<=h;)c.push(0);c[h]|=l<<8*(m+n%4*-1);f+=2}return{value:c,binLen:8*f+e}};break;case "B64":c=function(a,b,c){var e=0,f,
g;if(-1===a.search(/^[a-zA-Z0-9=+\/]+$/))throw Error("Invalid character in base-64 string");var h=a.indexOf("=");a=a.replace(/=/g,"");if(-1!==h&&h<a.length)throw Error("Invalid '=' found in base-64 string");b=b||[0];c=c||0;var d=c>>>3;for(h=0;h<a.length;h+=4){var l=a.substr(h,4);for(f=g=0;f<l.length;f+=1){var m="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(l[f]);g|=m<<18-6*f}for(f=0;f<l.length-1;f+=1){var u=e+d;for(m=u>>>2;b.length<=m;)b.push(0);b[m]|=(g>>>16-8*f&255)<<
8*(3+u%4*-1);e+=1}}return{value:b,binLen:8*e+c}};break;case "BYTES":c=function(a,b,c){var e;b=b||[0];c=c||0;var f=c>>>3;for(e=0;e<a.length;e+=1){var g=a.charCodeAt(e);var h=e+f;var d=h>>>2;b.length<=d&&b.push(0);b[d]|=g<<8*(3+h%4*-1)}return{value:b,binLen:8*a.length+c}};break;case "ARRAYBUFFER":try{c=new ArrayBuffer(0)}catch(J){throw Error("ARRAYBUFFER not supported by this environment");}c=function(a,b,c){var e;b=b||[0];c=c||0;var f=c>>>3;var g=new Uint8Array(a);for(e=0;e<a.byteLength;e+=1){var h=
e+f;var d=h>>>2;b.length<=d&&b.push(0);b[d]|=g[e]<<8*(3+h%4*-1)}return{value:b,binLen:8*a.byteLength+c}};break;default:throw Error("format must be HEX, TEXT, B64, BYTES, or ARRAYBUFFER");}return c}function g(a,b){return a>>>b|a<<32-b}function r(a,b,c){return a&b^~a&c}function l(a,b,c){return a&b^a&c^b&c}function q(a){return g(a,2)^g(a,13)^g(a,22)}function v(a){return g(a,6)^g(a,11)^g(a,25)}function B(a){return g(a,7)^g(a,18)^a>>>3}function A(a){return g(a,17)^g(a,19)^a>>>10}function n(a,b){var c=
...
3204075428],e=[1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225],a){case "SHA-224":break;case "SHA-256":b=e;break;case "SHA-384":b=[new c,new c,new c,new c,new c,new c,new c,new c];break;case "SHA-512":b=[new c,new c,new c,new c,new c,new c,new c,new c];break;default:throw Error("Unknown SHA variant");}else throw Error("No SHA variants supported");return b}function F(a,b,c){var e,f,g,m=[];if("SHA-224"===c||"SHA-256"===c){var p=64;var k=1;var h=Number;var d=n;
var t=w;var u=y;var x=B;var z=A;var C=q;var E=v;var F=l;var U=r;var V=H}else throw Error("Unexpected error in SHA-2 implementation");c=b[0];var O=b[1];var M=b[2];var P=b[3];var L=b[4];var N=b[5];var K=b[6];var Q=b[7];for(g=0;g<p;g+=1)16>g?(f=g*k,e=a.length<=f?0:a[f],f=a.length<=f+1?0:a[f+1],m[g]=new h(e,f)):m[g]=t(z(m[g-2]),m[g-7],x(m[g-15]),m[g-16]),e=u(Q,E(L),U(L,N,K),V[g],m[g]),f=d(C(c),F(c,O,M)),Q=K,K=N,N=L,L=d(P,e),P=M,M=O,O=c,c=d(e,f);b[0]=d(c,b[0]);b[1]=d(O,b[1]);b[2]=d(M,b[2]);b[3]=d(P,b[3]);
